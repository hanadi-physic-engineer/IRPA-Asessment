...
MODEL_PATH = "/home/an/irpa-asesment/3-keter-kemiringan-pipete/train_pipette_seg_weights/best.pt" 
        ...
        if result.boxes is not None:
            ...
            for box, cls_id, mask in zip(boxes, classes, masks):
                ...
                if "nose" in name:
                    ...
                    # Asumsi: Mulut objek adalah bagian tengah tepi atas (y1)
                    mouth_x = int((x1 + x2) / 2)
                    mouth_y = int(y1)
                    # Perkiraan panjang objek dalam piksel (panjang diagonal/sisi terpanjang)
